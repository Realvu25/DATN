...
public class LoginController {
	...
	//session doc ma hoa code
	@Autowired
	private poly.store.service.SessionService sessionService;
	...
	public String handlerLoginForm(Model model, @ModelAttribute("userLogin") @Validated UserLogin userLogin,
		...
		String usn = userLogin.getUsername();
		model.addAttribute("user", usn);
	...
	public String loginSuccess(Model model, HttpServletRequest request) {
		...
		poly.store.entity.User user = userService.findUserByEmail(email);
