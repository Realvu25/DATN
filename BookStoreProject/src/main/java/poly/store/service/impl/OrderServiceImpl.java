...
public class OrderServiceImpl implements OrderService{
	...
	public DetailOrder getDetailOrderByCode(String id) {
		...
		detailOrder.setNote(listOrder.get(0).getNote());
	...
	@Override
	public DetailOrder updateNote(DetailOrder detailOrder) {
		List<Order> listOrder = orderDao.getOrderByName(detailOrder.getId());
		for (Order order: listOrder) {
			order.setNote(detailOrder.getNote());
			orderDao.save(order);
		}
		return detailOrder;
	}
