...
public interface OrderDao extends JpaRepository<Order, Integer>{
	...
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE o.address.user.email = ?1 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
	List<OrderModel> listOrderHistory(String email);
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE o.status = 0 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
	List<OrderModel> listOrderGroupByCodePending();
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE o.status = 1 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
	List<OrderModel> listOrderGroupByCodeShipping();
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE o.status = 2 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
	List<OrderModel> listOrderGroupByCodeSuccess();
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE o.status = 3 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
	...
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE (o.status = 2) AND MONTH(o.date) = ?1 AND YEAR(o.date) = ?2 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
	List<OrderModel> listStatisticalRevenueMonth(int month, int year);
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE (o.status = 2) AND YEAR(o.date) = ?1 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
	List<OrderModel> listStatisticalRevenueYear(int year);
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status, o.note) FROM Order o WHERE (o.status = 2) AND DAY(o.date) = ?1 AND MONTH(o.date) = ?2 AND YEAR(o.date) = ?3 GROUP BY o.code, o.address.Fullname, o.date, o.status, o.note ORDER BY o.date ASC")
